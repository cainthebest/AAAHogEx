class HogeAI extends AIInfo {
	...
	function GetAuthor() {
		return "Rei Ishibashi";
	}
	function GetName() {
		return "AAAHogEx";
	}
	function GetDescription() {
		return "AAAHogEx is a highly competitive AI. This AI designs transportation routes based on the supply and demand of the map. Therefore, it works well in NewGRF such as FIRS, ECS, and YETI where complex industrial chains are required.";
	}
	function GetVersion() {
		return 94;
	} // main.nutも変更必要
	...
	function GetSettings() {
		...
		AddSetting({
			name = "IsAvoidSecondaryIndustryStealing",
		...
		AddSetting({
			name = "IsAvoidExtendCoverageAreaInTowns",
		...
		AddSetting({
			name = "disable_prefixed_station_name",
